...
code | reason | description | spec
---: | :----- | :---------- | :---
`4xx` | **Client Error** | "indicates that the client seems to have erred."  | [RFC7231#6.5](https://tools.ietf.org/html/rfc7231#section-6.5),<br> [RFC2616#10.4](https://tools.ietf.org/html/rfc2616#section-10.4)
...
code | reason | description | spec
---: | :----- | :---------- | :---
`5xx` | **Server Error** | "indicates that the server is aware that it has erred or is incapable of performing the requested method." | [RFC7231#6.6](https://tools.ietf.org/html/rfc7231#section-6.6),<br> [RFC2616#10.5](https://tools.ietf.org/html/rfc2616#section-10.5)
